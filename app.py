...
def user_input_features():
    ...
    number_1 = st.number_input("first number",min_value=0,max_value=2000000,step=1)
    number_2 = st.number_input("second number",min_value=0,max_value=2000000,step=1)
    number_3 = st.number_input("third number",min_value=0,max_value=2000000,step=1)
