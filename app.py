...
def user_input_features():
    ...
    number_2 = st.number_input("second number",min_value=0,max_value=float('inf'),step=1)
    number_3 = st.number_input("third number",min_value=0,max_value=float('inf'),step=1)
